...
class laser_gcode(inkex.Effect):
    ...
    def __init__(self):
        ...
        self.OptionParser.add_option("",   "--servo-up-command",                action="store", type="string",          dest="servo_up_command",                       default="M3",                      help="Laser gcode command")
        self.OptionParser.add_option("",   "--servo-down-command",              action="store", type="string",          dest="servo_down_command",                   default="M5",                         help="Laser gcode end command")       
        self.OptionParser.add_option("",   "--y-speed",                         action="store", type="int",             dest="y_speed",                         default="500",                          help="Laser speed (mm/min)")
        self.OptionParser.add_option("",   "--x-speed",                         action="store", type="string",          dest="x_speed",                        default="1000",                         help="Travel speed (mm/min)")
        self.OptionParser.add_option("",   "--servo-pwn",                       action="store", type="int",             dest="servo_pwn",                         default="90",                          help="S# is 256 or 10000 for full power")
        ...
        self.OptionParser.add_option("",   "--delay",                           action="store", type="string",          dest="delay",                         default="1",                          help="Laser power-on delay (ms)")
